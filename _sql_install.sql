...
('#modul_idname#', 0, 1, 7, 'newslettersignatur', 'Signatur', 'Die Signatur wird automatisch an alle Newsletter angeh&auml;ngt.', 'textarea', '5|50', '', '', '', 0, 0),
('#modul_idname#', 0, 1, 1, 'attachments','Dateianh&auml;nge verwenden?','','Ja|Nein','1|0','','1','1','0','0')
...
('#modul_idname#', 0, 1, 5, 'usecats', 'Kategorien verwenden?', NULL, 'Ja|Nein', '1|0', NULL, '0', '0', 0, 0),
